...
<!-- REGISTRAR DE MISIONEROS -->
        <div class="col-md-4">
            <div class="card h-100 border-dark shadow-sm">
                <div class="card-body text-center">
                    <h5>🧑‍💼 Registrar Misionero</h5>
                    <p>Agrega nuevos misioneros a la base de datos.</p>
                    <a href="registro_misionero.php" class="btn btn-outline-dark">Ir</a>
                </div>
            </div>
        </div>
