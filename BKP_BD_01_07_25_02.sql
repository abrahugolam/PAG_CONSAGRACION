...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-07-2025 a las 01:47:26
...
INSERT INTO `misioneros` (`id`, `nombres`, `apellidos`, `localidad`, `escuela`) VALUES
(1, 'Fernando', 'Casanova Rincon', 5, 'Escuela de Maria'),
(2, 'Carolina ', 'Chavez Lopez', 6, 'San Lorenzo'),
(3, 'Marcia', 'Lopez Ruiz', 7, 'Escuela de Maria'),
(4, 'Juan ', 'Lopez Tranzo', 10, 'Escuela de Maria'),
(5, 'Jefferson', 'Farfa Guadalupe', 7, 'Escuela de Maria'),
(6, 'Wilson', 'Tamayo', 12, 'Escuela de Maria');
