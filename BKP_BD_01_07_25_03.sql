...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-07-2025 a las 03:41:36
...
INSERT INTO `encargados_consagracion` (`id`, `misionero_id`, `grupo_id`, `funcion`) VALUES
(00001, 1, 1, 'Apoyo 1');
...
--
-- Estructura de tabla para la tabla `grupo_consagracion`
--

CREATE TABLE `grupo_consagracion` (
  `id` int(11) NOT NULL,
  `localidad_id` int(11) NOT NULL,
  `modalidad` enum('Presencial','Virtual') NOT NULL,
  `estado` enum('Activo (Inscripciones abiertas)','Activo (Inscripciones Cerradas)','Culminado','Cerrado') NOT NULL,
  `encargado_id` int(11) NOT NULL,
  `apoyo1_id` int(11) DEFAULT NULL,
  `apoyo2_id` int(11) DEFAULT NULL,
  `fecha_inicio` date NOT NULL,
  `dia` enum('Lunes','Martes','Miércoles','Jueves','Viernes','Sábado','Domingo') NOT NULL,
  `hora` time NOT NULL,
  `cantidad_integrantes_inicio` int(11) NOT NULL,
  ...
  `fecha_ceremonia` date DEFAULT NULL,
  `cantidad_consagrados` int(11) DEFAULT NULL,
  `fecha_cierre` date DEFAULT NULL,
  `motivo_cierre` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `grupo_consagracion`
--

INSERT INTO `grupo_consagracion` (`id`, `localidad_id`, `modalidad`, `estado`, `encargado_id`, `apoyo1_id`, `apoyo2_id`, `fecha_inicio`, `dia`, `hora`, `cantidad_integrantes_inicio`, `parroquia`, `departamento_id`, `provincia_id`, `distrito_id`, `direccion`, `fecha_ceremonia`, `cantidad_consagrados`, `fecha_cierre`, `motivo_cierre`) VALUES
(1, 6, 'Presencial', 'Activo (Inscripciones abiertas)', 6, 5, 2, '2025-05-13', 'Martes', '19:00:00', 30, 'Cristo Rey', '15', '1501', '150116', '0', NULL, NULL, NULL, NULL),
(2, 3, 'Presencial', 'Activo (Inscripciones abiertas)', 3, NULL, NULL, '2025-07-01', 'Martes', '10:30:00', 50, 'Virgen de la Candelaria', '07', '0701', '070103', '0', NULL, NULL, NULL, NULL);
...
INSERT INTO `integrantes` (`id`, `nombre_completo`, `grupo_id`, `fecha_nacimiento`, `celular`, `correo`) VALUES
(1, 'hugo Quiñones', 1, NULL, NULL, NULL),
(2, 'Karla Soto Collazos', 1, NULL, NULL, NULL),
(3, 'Julio Juanito Quiñones Sanchez', 1, NULL, NULL, NULL),
(4, 'Emiliano Martinez', 2, NULL, NULL, NULL),
(5, 'Abraham SAnchez', 1, NULL, NULL, NULL),
(6, 'Emilia Valdiezo Duran', 2, '1982-08-03', '985201267', 'emi.duna15@gmail.com'),
(7, 'Ingrid Pere', 2, '1993-02-15', '985214275', 'inr.pe@hotmail.com');
...
--
-- Estructura de tabla para la tabla `misioneros`
--

CREATE TABLE `misioneros` (
  `id` int(11) NOT NULL,
  `nombres` varchar(100) NOT NULL,
  `apellidos` varchar(100) NOT NULL,
  `n_documento` varchar(20) DEFAULT NULL,
  `localidad` int(11) DEFAULT NULL,
  `escuela` enum('Lectio Divina','San Lorenzo','Escuela de Maria') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `misioneros`
--

INSERT INTO `misioneros` (`id`, `nombres`, `apellidos`, `n_documento`, `localidad`, `escuela`) VALUES
(1, 'Fernando', 'Casanova Rincon', NULL, 5, 'Escuela de Maria'),
(2, 'Carolina ', 'Chavez Lopez', NULL, 6, 'San Lorenzo'),
(3, 'Marcia', 'Lopez Ruiz', NULL, 7, 'Escuela de Maria'),
(4, 'Juan ', 'Lopez Tranzo', NULL, 10, 'Escuela de Maria'),
(5, 'Jefferson', 'Farfa Guadalupe', NULL, 7, 'Escuela de Maria'),
(6, 'Wilson', 'Tamayo', NULL, 12, 'Escuela de Maria'),
(7, 'Danny', 'Escobedo', '5555555', 7, 'Escuela de Maria'),
(8, 'Hugo Felipe Rafael', 'Quiñones Sanchez', '72505634', 12, 'Escuela de Maria'),
(9, 'Hugo Felipe Rafael', 'Quiñones Sanchez', '72505634', 12, 'Escuela de Maria');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `misionero_roles`
--

CREATE TABLE `misionero_roles` (
  `misionero_id` int(11) NOT NULL,
  `rol_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `misionero_roles`
--

INSERT INTO `misionero_roles` (`misionero_id`, `rol_id`) VALUES
(1, 2),
(2, 7),
(3, 4),
(3, 6),
...
(2, 'rol_provincial', 'Equipo Provincial'),
(3, 'rol_localidad', 'Equipo Local'),
(4, 'rol_mision', 'Encargado Misión Consagración'),
(5, 'rol_padrino', 'Padrino de Consagración'),
(6, 'rol_encargado_con', 'Encargado de Consagración'),
(7, 'rol_apoyo_con', 'Apoyo de Consagración');
...
CREATE TABLE `ubigeo_peru_departments` (
  `id` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `usuarios` (
  ...
  `rol_id` int(11) NOT NULL,
  `id_misionero` int(11) NOT NULL,
  `condicion` enum('Activo','Inactivo') DEFAULT 'Activo'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `usuarios` (`id_usuario`, `user`, `password`, `rol_id`, `id_misionero`, `condicion`) VALUES
(00001, '5555555', '$2y$10$sdvNPQHy8G2fjW7DlbFEdu4boHGHVbRUGr123HvBORAEokaduClgi', 4, 7, 'Activo'),
(00002, '72505634', '$2y$10$ouAqzMOGdtVGUI32r04MAeg29EehXwrixaXd7yaQzRS9SBwb0cNQm', 1, 8, 'Activo');
...
ALTER TABLE `encargados_consagracion`
  ADD PRIMARY KEY (`id`),
  ADD KEY `misionero_id` (`misionero_id`),
...
--
-- Indices de la tabla `grupo_consagracion`
--
ALTER TABLE `grupo_consagracion`
  ADD PRIMARY KEY (`id`),
  ADD KEY `localidad_id` (`localidad_id`),
  ADD KEY `encargado_id` (`encargado_id`),
  ADD KEY `apoyo1_id` (`apoyo1_id`),
  ADD KEY `apoyo2_id` (`apoyo2_id`),
...
--
-- Indices de la tabla `misioneros`
--
ALTER TABLE `misioneros`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_localidad` (`localidad`);

--
-- Indices de la tabla `misionero_roles`
--
ALTER TABLE `misionero_roles`
  ADD PRIMARY KEY (`misionero_id`,`rol_id`),
...
ALTER TABLE `usuarios`
  ...
  ADD KEY `rol_id` (`rol_id`),
  ADD KEY `id_misionero` (`id_misionero`);
...
--
-- AUTO_INCREMENT de la tabla `grupo_consagracion`
--
ALTER TABLE `grupo_consagracion`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT de la tabla `misioneros`
--
ALTER TABLE `misioneros`
...
--
ALTER TABLE `usuarios`
  MODIFY `id_usuario` int(5) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `encargados_consagracion`
  ADD CONSTRAINT `encargados_consagracion_ibfk_1` FOREIGN KEY (`misionero_id`) REFERENCES `misioneros` (`id`),
  ADD CONSTRAINT `encargados_consagracion_ibfk_2` FOREIGN KEY (`grupo_id`) REFERENCES `grupos_consagracion` (`id`);

--
-- Filtros para la tabla `grupo_consagracion`
--
ALTER TABLE `grupo_consagracion`
  ADD CONSTRAINT `grupo_consagracion_ibfk_1` FOREIGN KEY (`localidad_id`) REFERENCES `localidades` (`id`),
  ADD CONSTRAINT `grupo_consagracion_ibfk_2` FOREIGN KEY (`encargado_id`) REFERENCES `misioneros` (`id`),
  ADD CONSTRAINT `grupo_consagracion_ibfk_3` FOREIGN KEY (`apoyo1_id`) REFERENCES `misioneros` (`id`),
  ADD CONSTRAINT `grupo_consagracion_ibfk_4` FOREIGN KEY (`apoyo2_id`) REFERENCES `misioneros` (`id`),
  ADD CONSTRAINT `grupo_consagracion_ibfk_5` FOREIGN KEY (`departamento_id`) REFERENCES `ubigeo_peru_departments` (`id`),
  ADD CONSTRAINT `grupo_consagracion_ibfk_6` FOREIGN KEY (`provincia_id`) REFERENCES `ubigeo_peru_provinces` (`id`),
  ADD CONSTRAINT `grupo_consagracion_ibfk_7` FOREIGN KEY (`distrito_id`) REFERENCES `ubigeo_peru_districts` (`id`);
...
--
-- Filtros para la tabla `misioneros`
--
ALTER TABLE `misioneros`
  ADD CONSTRAINT `fk_localidad` FOREIGN KEY (`localidad`) REFERENCES `localidades` (`id`);

--
-- Filtros para la tabla `misionero_roles`
--
ALTER TABLE `misionero_roles`
  ADD CONSTRAINT `misionero_roles_ibfk_1` FOREIGN KEY (`misionero_id`) REFERENCES `misioneros` (`id`),
  ADD CONSTRAINT `misionero_roles_ibfk_2` FOREIGN KEY (`rol_id`) REFERENCES `roles` (`id_rol`);
...
ALTER TABLE `usuarios`
  ...
  ADD CONSTRAINT `usuarios_ibfk_2` FOREIGN KEY (`id_misionero`) REFERENCES `misioneros` (`id`);
COMMIT;
